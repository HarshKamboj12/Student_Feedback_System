            ...
            <div class="carousel-inner">
                <div class="item active">
                    ...
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            <h1 class="animated3">
                                <span><strong>Feedback</strong> for better result</span>
                            </h1>
                            <p class="animated2">All the organisations want to be improved<br> And the feedback is going to be very useful entity in the improvement</p>	
                ...
                <div class="item">
                    ...
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            <h1 class="animated1">
                    		  <span>Welcome to <strong>Feedback</strong></span>
                    	    </h1>
                            <p class="animated2">Generate a flood of new idea with the<br> power of the reforming services.</p>
                            <a href="#portfolio" class="page-scroll btn btn-primary animated3">Read More</a>
                        </div>
                    </div>
                </div>
                <!--/ Carousel item end -->
