                    ...
                    <div class="col-md-12 col-xs-12">
                        <div class="welcome-section login-div">
                                ...
                                <form name="login" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control" placeholder="Password" name="password" data-validate="required">
                                    </div>
                                    <div class="form-group">
                                            <button name="login" value="login" class="btn btn-primary"> 
                                                <strong><span class="fa fa-key"></span> &nbsp;Login</strong>
                                            </button>
                                        <span class="pull-right"> <a href="forgot.php" >Forgot password ? </a>&nbsp;&nbsp;
